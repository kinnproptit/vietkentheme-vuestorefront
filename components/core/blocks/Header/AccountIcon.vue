<template>
  ...
  >
    <button type="button" class="bg-cl-transparent brdr-none p0 white-color">
    ...
    <no-ssr>
      <div
        v-show="currentUser"
        :class="['dropdown-content bg-cl-primary align-left sans-serif lh20 weight-400', !showMenu ? 'dropdown-content__hidden' : '']"
      >
        <div class="py5">
